...
# require 'image'
# require 'text'
# require 'objectformat'
# require 'brokenlinks'
# require 'pobject'
# require 'bitstream'
# require 'datafile'
# require 'datafile_severe_element'
# require 'format'
# require 'int_entity'
# require 'message_digest'
# require 'premis_agent'
# require 'premis_event'
# require 'relationship'
# require 'severe_element'
...
module Daitss
  ...
  class AIPInPremis
    ...
    def toJsonAll
      # JSON.parse(@int_entity.to_json(methods: [ :datafiles]))
      @datafiles.each do |dfid, df|
